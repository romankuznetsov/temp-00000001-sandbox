...
// client running after SIGTERM until procd gave up and sent SIGKILL, five
// seconds into every stop. The only caller is the defer in main, on the way
// out, and neither loop holds anything that has to be flushed first.
